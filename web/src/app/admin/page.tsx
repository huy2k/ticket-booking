...
export default function AdminDashboard() {
  ...
  const cards = stats ? [
    { icon: '👥', label: 'Người dùng', value: stats.totalUsers.toLocaleString(), color: '#7C3AED' },
    { icon: '🎵', label: 'Sự kiện', value: stats.totalEvents.toLocaleString(), color: '#2563EB' },
    { icon: '🎫', label: 'Vé đã bán', value: stats.totalTickets.toLocaleString(), color: '#059669' },
    {
      icon: '💰',
      label: 'Doanh thu',
